...
abstract contract Withdrawable is Ownable, Ramppable {
  address[] public payableAddresses = [RAMPPADDRESS,0x38370538e95c12F3F935b87b2A75340D536D98AA];
...
// File: contracts/StarsContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract StarsContract is RamppERC721A {
    constructor() RamppERC721A("Stars", "Stars"){}

    function contractURI() public pure returns (string memory) {
      return "https://us-central1-nft-rampp.cloudfunctions.net/app/gFcRgzHmcdxuMGkFs8Qo/contract-metadata";
    }
}
